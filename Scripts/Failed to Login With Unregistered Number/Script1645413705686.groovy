...
WebUI.setText(findTestObject('Login_EVERMOS/Page_Masuk Sebagai Reseller Evermos/input_Kata Sandi_inputText__input'), 'test')

WebUI.click(findTestObject('Login_EVERMOS/Page_Masuk Sebagai Reseller Evermos/button_Masuk'))

WebUI.verifyTextPresent('Nomor ini belum terdaftar sebagai reseller', false)
