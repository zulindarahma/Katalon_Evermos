...
WebUI.setText(findTestObject('Login_EVERMOS/Page_Masuk Sebagai Reseller Evermos/input_Kata Sandi_inputText__input'), '12345')

WebUI.click(findTestObject('Login_EVERMOS/Page_Masuk Sebagai Reseller Evermos/button_Masuk'))

WebUI.verifyTextPresent('Nomor Telepon atau Kata Sandi anda salah!', false)
